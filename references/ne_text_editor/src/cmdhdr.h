...
/* This header file contains a list of procedures for obeying
E commands. They have to be global so that they can be inserted
into a vector. */
...
extern int e_stream(cmdstr *);
extern int e_streammax(cmdstr *);
...
extern int e_unixregexp(cmdstr *);
...
extern int e_query(cmdstr *);
extern int e_right(cmdstr *);
extern int e_left(cmdstr *);
extern int e_sharp(cmdstr *);
extern int e_dollar(cmdstr *);
extern int e_percent(cmdstr *);
extern int e_tilde(cmdstr *);
